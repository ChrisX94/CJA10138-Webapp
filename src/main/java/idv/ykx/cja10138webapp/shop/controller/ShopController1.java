...
public class ShopController1 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if("update".equals(action)) { // get action: "update" from update_page.jsp" and also the parameters
            Map<String, String> errors = new LinkedHashMap<String, String>();
        ...
        /* **************************  Insert  ***************************  */
        if ("insert".equals(action)) {  // if the parameter from action is "insert"
            Map<String, String> errors = new LinkedHashMap<String, String>();
            req.setAttribute("errors", errors);
            /*get parameter from frontend, and check the format of parameters */
            String prodName = req.getParameter("prodName");
        ...
        /* **************************  Get One for Display  ***************************  */
        if ("getOne_For_Display".equals(action)) { // if the parameter from action is "getOne_For_Display"
