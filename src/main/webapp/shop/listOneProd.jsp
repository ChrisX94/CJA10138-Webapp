...
<%@ page import="idv.ykx.cja10138webapp.shop.service.ProdPicService" %>
...
<%
    ...
    ProdPicService picService = new ProdPicService();
    int imgNum = (picService.getProdPic(prod.getProdId())).size();
    ...
    <table id="table-1">
        <tr>
            <td>
                ...
                <h4><a href="product_page.jsp">回首頁</a>
                </h4>
            </td>
        </tr>
    </table>
...
<DIV>
    ...
    <IMG SRC="<%= request.getContextPath() %>/product-img?productId=${prod.prodId}&imgIndex=<%=i %>"  width="100" height="100">
    <% }%>
</DIV>
